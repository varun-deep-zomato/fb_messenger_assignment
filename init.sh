...
# Run DB setup script
echo "====================================================================="
echo "Running database schema setup (scripts/setup_db.py)..."
docker-compose exec app python scripts/setup_db.py

# Run test data generation script
echo "====================================================================="
echo "Running test data generation (scripts/generate_test_data.py)..."
docker-compose exec app python scripts/generate_test_data.py

echo "====================================================================="
echo "The FastAPI application is running at http://localhost:6969"
echo "Swagger API documentation available at http://localhost:6969/docs"
echo ""
